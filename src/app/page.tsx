  ...
  return (
    <>
      <main className="max-w-[1440px] mx-auto">
        <div className="flex items-center justify-between px-44 py-10">
          <div>
          ...
          <div className="font-Rubik space-x-10 text-xs">
              <button className="text-Very-Dark-Blue tracking-wider">FEATURES</button>
              <button className="text-Very-Dark-Blue tracking-wider">PRICING</button>
              <button className="text-Very-Dark-Blue tracking-wider">CONTACT</button>
              <button className="bg-Soft-Red py-[10px] px-8 rounded text-white tracking-wider shadow-md">LOGIN</button>
          </div>
        </div>
        <div className="pl-44 flex mt-14 font-Rubik">
          <div className="py-20">
        ...
        <div className="mt-12 flex items-center pl-44">
          <div className="relative">
            ...
            <div className="h-72 w-[150%] bg-Soft-Blue rounded-r-full absolute -left-[400px] top-44 -z-50"></div>
          </div>
          <div className="font-Rubik ml-24">
              <p className="text-3xl font-medium text-Very-Dark-Blue">Bookmark in one click</p>
              <p className="text-Grayish-Blue my-5 w-[62%]">Organize your bookmarks however you like. Our simple drag-and-drop interface 
              gives you complete control over how you manage your favourite sites.</p>
              <button className="bg-Soft-Blue text-white px-5 py-3 rounded-md text-xs shadow-md">More Info</button>
          </div>
        </div>
        <div className="mt-56">
          <div className="text-center font-Rubik">
              <p className="font-medium text-Very-Dark-Blue text-3xl">Download the extension</p>
              <p className="text-Grayish-Blue mt-3 w-[35%] mx-auto">We’ve got more browsers in the pipeline. Please do let us know if you’ve 
              got a favourite you’d like us to prioritize.</p>
          </div>
          <div className="relative  px-44 mt-8 ">
              <div className="grid place-items-center shadow-lg rounded absolute left-[20%] pt-10 pb-5 font-Rubik">
                <div>
                ...
                <p className="mt-5 font-medium text-Very-Dark-Blue text-xl">Add to Chrome</p>
                <p className="text-Grayish-Blue text-sm mt-1">Minimum version 62</p>
                <div className="mt-6">
              ...
              <div className="grid place-items-center shadow-lg rounded absolute left-[41%] top-10 pt-10 pb-5 font-Rubik">
                ...
                <p className="mt-5 font-medium text-Very-Dark-Blue text-xl">Add to Firefox</p>
                <p className="text-Grayish-Blue text-sm mt-1">Minimum version 55</p>
                <div className="mt-6">
                  <svg xmlns="http://www.w3.org/2000/svg" width="280" height="4"><path fill="#495DCF" fill-opacity=".2" fill-rule="evenodd" d="M0 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm280 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-17 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-18 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-17 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm122 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-70 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM88 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM70 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM53 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM35 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM18 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"/></svg>
                </div>
                <button className="mt-5 bg-Soft-Blue text-sm text-white w-[90%] py-2 rounded shadow-md">Add & Install Extension</button>
              ...
              <div className="grid place-items-center shadow-lg rounded absolute left-[62%] top-20 pt-10 pb-5 font-Rubik">
                ...
                <p className="mt-5 font-medium text-Very-Dark-Blue text-xl">Add to Opera</p>
                <p className="text-Grayish-Blue text-sm mt-1">Minimum version 46</p>
                <div className="mt-6">
                  <svg xmlns="http://www.w3.org/2000/svg" width="280" height="4"><path fill="#495DCF" fill-opacity=".2" fill-rule="evenodd" d="M0 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm280 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-17 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-18 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-17 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm122 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-35 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm-70 0a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM88 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM70 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM53 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM35 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4zM18 4a2 2 0 1 1 0-4 2 2 0 0 1 0 4z"/></svg>
                </div>
                <button className="mt-5 bg-Soft-Blue text-sm text-white w-[90%] py-2 rounded shadow-md">Add & Install Extension</button>
        ...
        <div className="bg-Very-Dark-Blue flex justify-between items-center px-44 py-5">
          <div className="flex items-center font-Rubik space-x-10 text-xs">
            <div>
            ...
            <button className="text-white tracking-wider">FEATURES</button>
            <button className="text-white tracking-wider">PRICING</button>
            <button className="text-white tracking-wider">CONTACT</button>
          </div>
          <div>
            <button>
