    ...
    return (
        <div className="lg:mt-56 mt-32">
          <div className="text-center font-Rubik">
              <p className="font-medium text-Very-Dark-Blue lg:text-3xl">Download the extension</p>
              <p className="text-Grayish-Blue mt-3 lg:w-[35%] mx-auto px-10">We’ve got more browsers in the pipeline. Please do let us know if you’ve 
              got a favourite you’d like us to prioritize.</p>
          </div>
          <div className="relative  lg:px-44 mt-8 ">
              <div className="grid place-items-center shadow-lg rounded lg:absolute left-[20%] pt-10 pb-5 font-Rubik">
                <div>
              ...
              <div className="grid place-items-center shadow-lg rounded lg:absolute left-[41%] top-10 pt-10 pb-5 font-Rubik">
                <div>
              ...
              <div className="grid place-items-center shadow-lg rounded lg:absolute left-[62%] top-20 pt-10 pb-5 font-Rubik">
                <div>
